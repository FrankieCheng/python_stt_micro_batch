#  Speech-to-Text GRPC to mock the stream requests/responses for users to transcript microphone.
...
It is recommended to use Linux to deploy the server can solve lots of compatibility problems.
